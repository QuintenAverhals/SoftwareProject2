	...
	public static void main(String[] args) throws Exception {
		try {
			factory = new Configuration().configure().addAnnotatedClass(TrainingWerknemer.class)
					...
					.addAnnotatedClass(Survey.class).addAnnotatedClass(Login.class).addAnnotatedClass(Location.class)
					.addAnnotatedClass(Training.class).addAnnotatedClass(LoginWebsite.class).buildSessionFactory();
