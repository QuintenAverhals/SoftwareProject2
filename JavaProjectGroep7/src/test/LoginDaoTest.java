...
public class LoginDaoTest {
	...
	@Ignore
	@Test
	// a test of the check function which checks if the given username and password
	// is correct
	...
	public void testCreateNewUser() throws Exception {
		...
		nieuweUser.createNewUser(nieuweUser.getUsername(), nieuweUser.getPassword(), nieuweUser.isAdmin(),
				nieuweUser.getEmail());
	...
	/*
	 * @Test public void testUpdatePassword() { getUser= new Login(); int id= 1;
	 * String username= "Basil"; getUser.updateUserName(id, username); checkUserList
	 * = getUser.getUsersByName(username); for(int i=0;i< checkUserList.size();i++)
	 * {
	 * 
	 ...
	 * }
	 * 
	 * @Test public void testUpdateUserName() { getUser= new Login(); int id= 1;
	 * String username="seppe"; getUser.updateUserName(id, username); checkUserList
	 * = getUser.getUsersByName(username); for(int i=0;i< checkUserList.size();i++)
	 * {
	 * 
	 * checkUser= checkUserList.get(i);
