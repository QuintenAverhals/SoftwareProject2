...
<body>
	<?php
		...
		if(ISSET($_POST['submit'])){
			...
			$query="SELECT * FROM LOGIN_WEBSITE WHERE WebsiteUserName ='" .$_POST['username']."'";
...
<body>
	...
	If you want to change your password for the website, 
	<a href="http://kaaimannen.be/Seppe/wachtwoord_vergeten_change.php?a='.$userid.'&nbvcb='.$lengthPassword.'&xwmlc='.$emailadres.'">click here.</a>  <br><br>
...
';
			...
			echo "<form action='wachtwoord_vergeten.php' method='post' enctype='multipart/form-data'>
